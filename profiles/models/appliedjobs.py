...
class AppliedJobs(models.Model):
    job = models.ForeignKey('mainsite.Job', on_delete=models.CASCADE, related_name='applied_jobs')
    jobseeker = models.ForeignKey(JobSeeker, on_delete=models.CASCADE, related_name='applied_user')

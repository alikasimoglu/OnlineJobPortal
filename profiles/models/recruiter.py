...
class Recruiter(models.Model):
    ...
    avatar_thumbnail_140x140 = ImageSpecField(source='avatar', processors=[Transpose(), ResizeToFill(140, 140)], format='WEBP', options={'quality': 80})
    ...
    def get_absolute_url(self):
        return reverse('profiles:recruiter_profile', args=[self.slug])

...
from mainsite.views import IndexView, JobSeekerProfilesView, JobsView, JobDetailView, JobUpdateView, JobCreateView, \
    AppliedApplicantsView, SearchResultsView, RelatedJobsView
...
urlpatterns = [
    ...
    path('ilgili-is-ilanlari/', RelatedJobsView.as_view(), name='related_job_list'),
    ...
    path('arama/', SearchResultsView.as_view(), name='search_results'),
]
